    ...
    <section className='flex flex-col m-5 gap-6 lg:flex-row lg:justify-between lg:mt-4  animate__animated animate__fadeInDown'>
      <div className='flex flex-col gap-5 lg:w-1/2 lg:justify-center lg:gap-7'>
        ...
        <div>
          <Link
            href='/contact'
            className='bg-transparen text-fontColorTitles border border-purpleColor pt-2 pb-2 pr-4 pl-4 hover:bg-purpleColor hover:text-fontColor hover:border-fontColor'
          >
            {t('contact')}
          </Link>
        </div>
