    ...
    <div>
      ...
      <div className='border border-solid border-borderColor'>
        <div className='p-5 flex flex-col justify-between'>
          ...
          <div>
            <Link href='/contact' className='bg-transparen text-fontColorTitles font-medium border border-purpleColor pt-2 pb-2 pr-4 pl-4 hover:bg-purpleColor hover:text-fontColor hover:border-fontColor'>
              {t('button')} =&gt;
            </Link>
          </div>
        </div>
